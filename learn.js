...
try {
    var myListener1 = function () {
        ...
        Storage.Variables.dtcu = 'mousemove'
    };
...
try {
    var myListener2 = function () {
        ...
        Storage.Variables.dtcv = 'mousedown'
    };
...
try {
    var myListener3 = function () {
        ...
        Storage.Variables.dtcw = 'keydown'
    };
...
try {
    var myListener5 = function () {
        ...
        Storage.Variables.dtcy = 'ontouchstart'
    };
...
try {
    var myListener6 = function () {
        ...
        Storage.Variables.dtcz = 'ontouchmove'
    };
...
var Learn = {
    ...
    ResultItems: ['ria', 'rib', 'ric', 'rid', 'rie', 'fpq', 'fph', 'fpf', 'fpg', 'fpe', 'rif', 'rig', 'ril', 'rih', 'rihB', 'riy', 'riz', 'fpa', 'fpb', 'fpc', 'fpd', 'fpi', 'fpj', 'fpk', 'fpm', 'fpn', 'fpo', 'fpp', 'fpr', 'rii', 'fps', 'fpt', 'HLL', 'HLR', 'HLO', 'HLB', 'fpu', 'fpv', 'rij', 'rik', 'fpw', 'fpx', 'dtqq', 'fpy', 'fpz', 'dpi', 'fpdt', 'fpem', 'fpcs', 'fpnn', 'fpam', 'fpcd', 'fpsl', 'fpct', 'fplt', 'fppc', 'fpfg', 'fpfc', 'fpfd', 'fpss', 'fpfs', 'fpfe', 'fpsb', 'fkmt', 'fksb'],
    ...
    ipqsd: function () {
        ...
        if (d !== undefined && d !== "" && d !== null && d !== "null" && d !== undefined && d !== "undefined") {
            ...
            var f = setTimeout(function () {
                Storage.Variables.ipqsd = "timedout";
                Storage.TotalCompleted++
            }, 1000);
            xmlrr = new XMLHttpRequest();
            xmlrr.open('GET', "https://fn.us.ipqualityscore.com/udid/udid.json", !0);
    ...
    fpx: function () {
        ...
        try {
            var _0x5b69 = ["undefined", "hidden", "dtss", "Variables", "mozHidden", "msHidden", "webkitHidden"];
            var d = document;
    ...
    fpy: function () {
        ...
        var _0xa529 = ["width", "not an object", "indexOf", "dttt", "Variables", "s", "Cannot read", "c", "e is undefined", "f", "Unable to get property \'width\' of undefined or null reference", "documentMode", "StyleMedia", "e", "i"];
        try {
            var e;
            var f = e[_0xa529[0]]
        } catch (e) {
    ...
    fpz: function () {
        ...
        var _0x63ef = ["opr", "addons", "opera", " OPR/", "indexOf", "userAgent", "dtuu", "Variables", "o", "undefined", "f", "documentMode", "i", "StyleMedia", "e", "chrome", "webstore", "c"];
        try {
    ...
    ril: function () {
        ...
        try {
            var _0x43de = ["phantomjs", "indexOf", "toLowerCase", "stack", "selenium", "triflejs", "specterjs", "slimerjs", "casperjs", "webdriver"];
        ...
        try {
            var _0x7ba6 = ["callPhantom", "function", "_phantom", "__phantomas", "Buffer", "emit", "spawn", "webdriver", "domAutomation", "domAutomationController", "navigator", "getAttribute", "documentElement", "document", "_Selenium_IDE_Recorder", "__webdriver_script_fn", "PhantomEmitter"];
        ...
        try {
            var _0x8b9a = ["callSelenium", "_selenium", "__nightmare", "awesomium", "__webdriver_script_fn", "__webdriver_evaluate", "__selenium_evaluate", "__webdriver_script_function", "__webdriver_script_func", "__fxdriver_evaluate", "__driver_unwrapped", "__webdriver_unwrapped", "__driver_evaluate", "__selenium_unwrapped", "__fxdriver_unwrapped"];
        ...
        try {
            var _0xf537 = ["_globalProxy", "_virtualConsole", "_pretendToBeVisual", "_currentSessionHistoryEntryIndex", "__stopAllTimers", "jscWebView", "gi", "match", "length"];
        ...
        try {
            if (document.$chrome_asyncScriptInfo || document.__$webdriverAsyncExecutor || document.$cdc_asdjflasutopfhvcZLmcf || document.$cdc_asdjflasutopfhvcZLmcfl_) {
                ril_val = !0
            }
        } catch (err) {}
        try {
            var _cs = ["om", "man", "__l", "we", "fSh", "web", "ti", "Ru", "et", "rC", "-", "as", "RI", "wdi", "Ce", 'b64', "erC", "func", "ir", "erF", "BD", "Chr", "_WE", "w", "dr", "rPr", "fi", "__", "riv", "Te", "en", "cal", "_ta", "ver", "ati", "iv", "EM_", "VER", "fmg", "ts", "oEl", "Sel", "bd", "nig", "ert", "ium", "led", "omp", "rm", "tW", "las", "CA", "nPe", "t", "htm", "la", "unc", "E", "ome", "Al", "p", "ec", "tWa", "on", "geb", "rge", "CH", "at", "d", "ar", "Dri", "_EL", "st", "e", '&', "tr", "rf", "stW"];
            if (window[_cs[27] + _cs[3] + _cs[42] + _cs[28] + _cs[19] + _cs[56]] || window[_cs[2] + _cs[11] + _cs[49] + _cs[67] + _cs[18] + _cs[59] + _cs[44]] || window[_cs[27] + _cs[50] + _cs[62] + _cs[6] + _cs[9] + _cs[63] + _cs[26] + _cs[48]] || window[_cs[27] + _cs[55] + _cs[77] + _cs[34] + _cs[25] + _cs[47] + _cs[53]] || window[_cs[22] + _cs[20] + _cs[12] + _cs[37] + _cs[71] + _cs[36] + _cs[51] + _cs[66] + _cs[57]] || window[_cs[21] + _cs[58] + _cs[70] + _cs[33] + _cs[23]] || window[_cs[13] + _cs[40] + _cs[61] + _cs[75] + _cs[63]] || window[_cs[5] + _cs[24] + _cs[35] + _cs[16] + _cs[0] + _cs[1] + _cs[68]] || window[_cs[43] + _cs[54] + _cs[69] + _cs[73]] || window[_cs[38] + _cs[8] + _cs[32] + _cs[65] + _cs[39]] || window[_cs[14] + _cs[4] + _cs[69] + _cs[60]] || window[_cs[7] + _cs[52] + _cs[76] + _cs[29] + _cs[72]] || window[_cs[64]] || document[_cs[31] + _cs[46] + _cs[41] + _cs[30] + _cs[45]]) {
                ril_val = !0
            }
        } catch (err) {}
    ...
    riz: function () {
        ...
        try {
            var _0xbcd6 = ["orientation", "undefined", "ontouchstart", "documentElement", "IEMobile", "indexOf", "userAgent"];
    ...
    HandleCandidate: function (candidate) {
        ...
        if (handler !== null && handler[1] !== undefined) {
            ...
            var ip = ipaddr.trim();
            if (ip.match(/^(192\.168\.|192\.0\.0\.([0-9])|169\.254\.|10\.|100\.((6[4-9]|[7-9][0-9]|1[01][0-9]|12[0-7]))|172\.(1[6-9]|2\d|3[01]))/)) {}
...
var Startup = {
    ...
    SubmitLock: !1,
    FormFieldPrepend: '',
    SetFormFieldPrepend: function (value) {
        Startup.FormFieldPrepend = value
    },
    ...
    Submit: function () {
        if (Startup.SubmitLock === !1) {
            ...
            setTimeout(function () {
                ...
                http.open("POST", 'https://fn.us.ipqualityscore.com/api/*', !0);
                    ...
                    if (Storage.Variables !== undefined && Storage.Variables[key] !== undefined && Storage.Variables[key].join !== undefined) {
                        if (typeof Storage.Variables[key] === 'object') {
                            for (var i = 0; i < Storage.Variables[key].length; i++) {
                                result.push(key + '[]=' + encodeURIComponent(JSON.stringify(Storage.Variables[key][i])))
                            }
                        } else {
                        ...
                        result.push(key + '=' + encodeURIComponent(Storage.Variables[key]))
                    }
                }
